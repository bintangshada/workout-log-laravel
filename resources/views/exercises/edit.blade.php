                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('exercises.update', $exercise) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" 
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('exercises.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded mr-2">
                                Cancel
                            </a>
