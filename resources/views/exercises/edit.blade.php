    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-2xl border border-gray-100 dark:border-gray-700">
                <div class="p-8">
                    <header class="mb-8">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white">Edit: {{ $exercise->name }}</h3>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Update the details of this exercise.</p>
                    </header>

                    <form action="{{ route('exercises.update', $exercise) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
